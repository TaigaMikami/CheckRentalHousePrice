...
class User
  # attr_accessor :room_type, :num_rooms, :square, :floor, :building_type, :structure_type, :floor_height

  def initialize(room_type, num_rooms, square, floor, building_type, structure_type,floor_height)
    @room_type = room_type
    @num_rooms = num_rooms
    @square = square
    @floor = floor
  ...
  # ユーザーIDをもとにJSONデータからモデルを作成するメソッド
  def self.getUser(room_type, num_rooms, square, floor, building_type, structure_type,floor_height)
